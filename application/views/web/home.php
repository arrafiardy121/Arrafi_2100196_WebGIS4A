         ...
         <div class="header_bg">
            <div class="container">
               <nav class="navbar navbar-expand-lg navbar-light bg-light">
                  <a class="logo" href="index.html"><img src="<?=base_url()?>assets/web/images/logo.png"></a>
                  ...
                  <div class="collapse navbar-collapse" id="navbarSupportedContent">
                     ...
                     <div class="call_section">
                        <ul>
                           <li><a href="#"><img src="<?=base_url()?>assets/web/images/fb-icon.png"></a></li>
                           <li><a href="#"><img src="<?=base_url()?>assets/web/images/twitter-icon.png"></a></li>
                           <li><a href="#"><img src="<?=base_url()?>assets/web/images/linkedin-icon.png"></a></li>
                           <li><a href="#"><img src="<?=base_url()?>assets/web/images/instagram-icon.png"></a></li>
                           <div class="donate_bt"><a href="#"><img src="<?=base_url()?>assets/web/images/search-icon.png"></a></div>
                        </ul>
                     </div>
                  </div>
               </nav>
                  ...
                  <div class="container">
                     <div class="banner_taital_main">
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="image_1"><img src="<?=base_url()?>assets/web/images/img-1.png"></div>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="footer_section_2">
               <div class="row">
                  <div class="col-lg-3 margin_top">
                     <div class="call_text"><a href="#"><img src="<?=base_url()?>assets/web/images/call-icon1.png"><span class="padding_left_15">Call Now +01 9876543210</span></a></div>
                     <div class="call_text"><a href="#"><img src="<?=base_url()?>assets/web/images/mail-icon1.png"><span class="padding_left_15">demo@gmail.com</span></a></div>
                  </div>
                  <div class="col-lg-3">
                  ...
                  <div class="col-lg-3">
                     <div class="information_main">
                        <div class="footer_logo"><a href="index.html"><img src="<?=base_url()?>assets/web/images/footer-logo.png"></a></div>
                     </div>
                  </div>
               </div>
            </div>
