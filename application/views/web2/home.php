...
<head>
  ...
  <!-- fevicon -->
  <link rel="icon" href="<?=base_url()?>assets/web2/images/fevicon.png" type="image/gif" />
  <!-- bootstrap css -->
  <link rel="stylesheet" href="<?=base_url()?>assets/web2/css/bootstrap.min.css">
  <!-- style css -->
  <link rel="stylesheet" href="<?=base_url()?>assets/web2/css/style.css">
  <!-- Responsive-->
  <link rel="stylesheet" href="<?=base_url()?>assets/web2/css/responsive.css">  
  <!-- Scrollbar Custom CSS -->
  <link rel="stylesheet" href="<?=base_url()?>assets/web2/css/jquery.mCustomScrollbar.min.css">
  <!-- Tweaks for older IEs-->
  <link rel="stylesheet" href="https://netdna.bootstrapcdn.com/font-awesome/4.0.3/<?=base_url()?>assets/web2/css/font-awesome.css">
...
<body class="main-layout">
  <!-- loader  -->
  <div class="loader_bg">
    <div class="loader"><img src="<?=base_url()?>assets/web2/images/loading.gif" alt="#" /></div>
  </div>
  <!-- end loader -->
  <!-- header -->
  <header>
          ...
          <div class="row">
            <div class="col-xl-2 col-lg-4 col-md-4 col-sm-3 col logo_section">
              <div class="full">
                <div class="center-desk">
                  <div class="logo">
                    <a href="index.html"><img src="<?=base_url()?>assets/web2/images/logo.png" alt="#" /></a>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xl-10 col-lg-8 col-md-8 col-sm-9">
              <div class="header_information">
               ...
               <div class="mean-last">
                       <a href="#"><img src="<?=base_url()?>assets/web2/images/search_icon.png" alt="#" /></a> <a href="#">login/sing up</a></div>              
             </div>
           </div>
         </div>
       </div>
                ...
                <div class="row">
                  ...
                  <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                    <div class="images_box">
                      <figure><img src="<?=base_url()?>assets/web2/images/img2.png"></figure>
                    </div>
                  </div>
                </div>
              </div>
...
<div id="about" class="about">
  <div class="container">
    <div class="row">
      ...
      <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
        <div class="about-box">
          <figure><img src="<?=base_url()?>assets/web2/images/about.jpg" alt="#" /></figure>
        </div>
      </div>
    </div>
        ...
        <div class="box_bg">
          <div class="box_bg_img">
            <div class="row">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?=base_url()?>assets/web2/images/my1.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?=base_url()?>assets/web2/images/my2.jpg"></figure>
                  <div class="overlay">
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?=base_url()?>assets/web2/images/my3.jpg"></figure>
                  <div class="overlay">
                    <h3>Skills</h3>
                    <p>It is a long established fact that a reader will be distracted by the readable content o</p>
                  </div>
              ...
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                <div class="box_my">
                  <figure><img src="<?=base_url()?>assets/web2/images/my4.jpg"></figure>
                  <div class="overlay">
...
<div id="learn" class="learn">
  <div class="container">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="learn_box">
          <figure><img src="<?=base_url()?>assets/web2/images/img.jpg" alt="img"/></figure>
        </div>
      </div>
    </div>
  </div>
...
<div class="make">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12">
        <div class="make_img">
          <figure><img src="<?=base_url()?>assets/web2/images/make_img.jpg"></figure>
        </div>
      </div>
    </div>
  </div>
    ...
    <footr>
      <div class="footer ">
        <div class="container">
              ...
              <div class="row">
                <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 ">
                  <div class="address">
                    ...
                    <ul class="loca">
                      <li>
                        <a href="#"><img src="<?=base_url()?>assets/web2/images/loc.png" alt="#" /></a>London 145
                        <br>United Kingdom </li>
                        <li>
                          <a href="#"><img src="<?=base_url()?>assets/web2/images/email.png" alt="#" /></a>demo@gmail.com </li>
                          <li>
                            <a href="#"><img src="<?=base_url()?>assets/web2/images/call.png" alt="#" /></a>+12586954775 </li>
                          </ul>
                          <ul class="social_link">
                            <li><a href="#"><img src="<?=base_url()?>assets/web2/images/fb.png"></a></li>
                            <li><a href="#"><img src="<?=base_url()?>assets/web2/images/tw.png"></a></li>
                            <li><a href="#"><img src="<?=base_url()?>assets/web2/images/lin(2).png"></a></li>
                            <li><a href="#"><img src="<?=base_url()?>assets/web2/images/instagram.png"></a></li>
                          </ul>
                      ...
                      <div class="col-lg-3 col-md-6 col-sm-6 ">
                        <div class="address">
                          <a href="index.html"> <img src="<?=base_url()?>assets/web2/images/logo1.jpg" alt="logo"></a>
                        </div>
                      </div>
                    </div>
                  </div>
          ...
          <!-- end footer -->
          <!-- Javascript files-->
          <script src="<?=base_url()?>assets/web2/js/jquery.min.js"></script>
          <script src="<?=base_url()?>assets/web2/js/popper.min.js"></script>
          <script src="<?=base_url()?>assets/web2/js/bootstrap.bundle.min.js"></script>
          <script src="<?=base_url()?>assets/web2/js/jquery-3.0.0.min.js"></script>
          <script src="<?=base_url()?>assets/web2/js/plugin.js"></script>
          <!-- sidebar -->
          <script src="<?=base_url()?>assets/web2/js/jquery.mCustomScrollbar.concat.min.js"></script>
          <script src="<?=base_url()?>assets/web2/js/custom.js"></script>
...
function initMap() {
  ...
  var image = '<?=base_url()?>assets/web2/images/maps-and-flags.png';
